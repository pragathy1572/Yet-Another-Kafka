            ...
            while True:
                try:
                    ...
                    if message == "producer":
                        ...
                        latest.append(data)
                        directory = topic
                        parent_dir = "D:/mini-kafka-with-socket-main/broker1"
                        parent_dir1 = "D:/mini-kafka-with-socket-main/broker2"
                        parent_dir2 = "D:/mini-kafka-with-socket-main/broker3"
                    ...
                    # print(data)
                        ...
                        if method == "early":
                            ...
                            print(topic)
                            parent_dir = "D:/mini-kafka-with-socket-main/broker3"
                            path = os.path.join(parent_dir, topic)
                            if os.path.exists(path):
